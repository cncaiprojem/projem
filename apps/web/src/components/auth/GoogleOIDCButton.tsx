...
interface GoogleOIDCButtonProps {
  text?: string
  redirectUrl?: string
  onSuccess?: () => void
...
export default function GoogleOIDCButton({
  text,
  redirectUrl = '/jobs',
  onSuccess,
  onError,
  className = '',
}: GoogleOIDCButtonProps) {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      const response = await authAPI.initiateGoogleOIDC(redirectUrl)
