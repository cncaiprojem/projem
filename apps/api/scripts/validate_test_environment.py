...
class TestEnvironmentValidator:
    ...
    def validate_python_imports(self) -> bool:
        ...
        for module, description in optional_imports:
            try:
                ...
                self.warnings.append(f"Optional: {module} ({description}) - some features may be limited")
    ...
    def validate_security_requirements(self) -> bool:
        ...
        try:
            ...
            if not hasattr(MigrationTestConfig, 'DEFAULT_CURRENCY'):
                ...
                self.warnings.append(f"Expected TRY currency, got: {MigrationTestConfig.DEFAULT_CURRENCY}")
    ...
    def run_smoke_test(self) -> bool:
        ...
        try:
            ...
            db_url = os.getenv("DATABASE_URL", "postgresql+psycopg2://freecad:password@localhost:5432/freecad")
