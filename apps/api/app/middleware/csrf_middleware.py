    ...
    **Security Events:**
    ...
    def __init__(self, app, require_auth_for_csrf: Optional[bool] = None):
        ...
        self.require_auth_for_csrf = (
            require_auth_for_csrf if require_auth_for_csrf is not None 
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> StarletteResponse:
        ...
        if any(exempt_ua in user_agent for exempt_ua in self.exempt_user_agents):
            logger.debug("CSRF protection bypassed for exempt user agent", extra={
        ...
        try:
            ...
            validation_result = csrf_service.validate_csrf_token(
                ...
                request=request,
                user_id=user_id,
                require_auth=self.require_auth_for_csrf
            )
            ...
            if validation_result != CSRFValidationResult.VALID:
                ...
                logger.warning("CSRF protection blocked request", extra={
            ...
            logger.debug("CSRF protection passed", extra={
            ...
            logger.error("CSRF middleware error", exc_info=True, extra={
    ...
    async def __call__(self, request: Request, db: Session) -> None:
        ...
        try:
            ...
            if validation_result != CSRFValidationResult.VALID:
                ...
                logger.warning("CSRF dependency blocked request", extra={
            ...
            logger.error("CSRF dependency error", exc_info=True, extra={
