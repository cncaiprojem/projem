...
from sqlalchemy import String, BigInteger, ForeignKey, Index, DateTime, UniqueConstraint
...
class Artefact(Base, TimestampMixin):
    ...
    # Relationships
    job: Mapped["Job"] = relationship("Job", back_populates="artefacts", foreign_keys=[job_id])

    # Enterprise-grade indexing strategy
    __table_args__ = (
        Index("idx_artefacts_job_id_type", "job_id", "type"),
        Index("idx_artefacts_sha256", "sha256", postgresql_where="sha256 IS NOT NULL"),
        Index("idx_artefacts_size_bytes", "size_bytes"),
        Index("idx_artefacts_created_at", "created_at"),
