...
class NotificationDelivery(Base, TimestampMixin):
    ...
    subject: Mapped[Optional[str]] = mapped_column(
        String(255),
        nullable=True,
        comment="Rendered subject (null for SMS)"
    )
    
    body: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        comment="Rendered message body"
    )
    ...
    primary_provider: Mapped[NotificationProvider] = mapped_column(
        nullable=False,
        comment="Primary provider to attempt"
    )
    ...
    error_code: Mapped[Optional[str]] = mapped_column(
        ...
        nullable=True,
        index=True,
        comment="Error code for failed deliveries"
    )
    ...
    __table_args__ = (
        ...
        Index('idx_notifications_delivery_provider_tracking', 'provider_message_id', 'actual_provider'),
    ...
    @classmethod
    def get_pending_notifications(cls, db_session, limit: int = 100) -> list["NotificationDelivery"]:
