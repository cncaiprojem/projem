    ...
    def validate(cls, value: Any, enum_name: str) -> bool:
        ...
        if isinstance(value, str):
            try:
                ...
                raise ValueError(
                    f"Invalid {enum_name} value '{value}'. Valid values: {valid_values}"
                )
...
class AuditChainValidator:
    ...
    def verify_chain_integrity(
        cls, current_hash: str, data: Dict[str, Any], prev_hash: Optional[str] = None
    ) -> bool:
...
def setup_model_validators():
    ...
    def _validate_instance(instance):
        ...
        if hasattr(instance, "idempotency_key"):
            IdempotencyKeyValidator.validate(instance.idempotency_key, context=table_name)
        ...
        if table_name == "audit_logs":
            ...
            if hasattr(instance, "prev_chain_hash"):
                AuditChainValidator.validate_hash_format(
                    instance.prev_chain_hash, "prev_chain_hash"
                )
