...
class Model(Base, TimestampMixin):
    ...
    type: Mapped[ModelType] = mapped_column(SQLEnum(ModelType), nullable=False)
    file_format: Mapped[FileFormat] = mapped_column(SQLEnum(FileFormat), nullable=False)
    ...
    parent_model: Mapped[Optional["Model"]] = relationship(
        "Model", remote_side=[id], backref="versions"
    )
