...
health_router = APIRouter(prefix="/api/v1/environment", tags=["environment-health"])
    ...
    try:
        ...
        features = {
            "development": {
                ...
                "response_annotations": environment_service.is_feature_enabled(
                    "response_annotations"
                ),
                "csrf_localhost_bypass": environment_service.is_feature_enabled(
                    "csrf_localhost_bypass"
                ),
            },
            "security": {
        ...
        logger.error(
            ...
            exc_info=True,
            extra={"operation": "feature_flags_error", "error_type": type(e).__name__},
        )
    ...
    **Compliance**: Does not log PII, safe for unauthenticated access
    ...
    try:
        ...
        logger.error(
            ...
            exc_info=True,
            extra={"operation": "environment_health_error", "error_type": type(e).__name__},
        )
