...
class PasswordService:
    ...
    def _compute_argon2_hash(self, peppered_password: str, salt: str) -> str:
        ...
        try:
            ...
            raw_hash = self.hasher._hash(
                peppered_password.encode("utf-8"), salt_bytes, **ARGON2_CONFIG
            )
    ...
    def verify_password(
        self, password: str, stored_hash: str, salt: str, algorithm: str = "argon2id"
    ) -> bool:
        """
    ...
    def validate_password_strength(
        ...
        if password.lower() in WEAK_PASSWORDS:
            feedback.append(
                "Bu şifre çok yaygın kullanılmaktadır, lütfen daha güçlü bir şifre seçin"
            )
            score -= 30
        ...
        min_requirements_met = (
            ...
            and not self._has_repeated_patterns(password)
        )
