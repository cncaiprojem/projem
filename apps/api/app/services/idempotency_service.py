...
class IdempotencyService:
    ...
    async def get_response(
        cls, db: Session, key: str, user_id: int | UUID, endpoint: Optional[str] = None
        ...
        try:
            ...
            if record.is_expired():
                logger.info(
                    ...
                    extra={"user_id": str(user_id), "expired_at": record.expires_at.isoformat()},
                )
        ...
        try:
            ...
            if expired_count > 0:
                logger.info(
                    ...
                    extra={"deleted_count": expired_count, "cleanup_time": now.isoformat()},
                )
