...
class InputSanitizationService:
    ...
    def validate_against_xss(self, input_text: str) -> Dict[str, Any]:
        ...
        return {"is_safe": len(threats) == 0, "threats": threats, "input_length": len(input_text)}
    ...
    def validate_against_path_traversal(self, input_text: str) -> Dict[str, Any]:
        ...
        for pattern in self.compiled_path_patterns:
            ...
            if matches:
                threats.append(
                    {"type": "PATH_TRAVERSAL", "pattern": pattern.pattern, "matches": matches[:5]}
                )
    ...
    def validate_against_command_injection(self, input_text: str) -> Dict[str, Any]:
        ...
        if len(input_text) > 3 and any(
            operator in input_text
    ...
    def comprehensive_validate(self, input_text: str) -> Dict[str, Any]:
        ...
        is_safe = (
            xss_result["is_safe"]
            and sql_result["is_safe"]
            and path_result["is_safe"]
            and cmd_result["is_safe"]
        )
