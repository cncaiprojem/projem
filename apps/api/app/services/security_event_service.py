    ...
    async def create_security_event(
        ...
        try:
            ...
            if metadata:
                ...
                # Create minimal metadata with severity for filtering
                masked_metadata = {}
            
            # Always ensure severity is in metadata for filtering
            if masked_metadata is None:
                masked_metadata = {}
            masked_metadata["severity"] = severity.value
