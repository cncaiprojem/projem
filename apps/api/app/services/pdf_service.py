    ...
    async def generate_invoice_pdf(
        ...
        try:
            ...
            try:
                ...
                logger.info(f"Successfully generated PDF with ReportLab for invoice {invoice.number}")
            except Exception as e2:
                logger.error(f"Both WeasyPrint and ReportLab failed for invoice {invoice.number}: {e2}")
        ...
        try:
            ...
            await self._upload_pdf_to_storage(
                pdf_content,
                object_key,
                invoice.number,
                checksum
