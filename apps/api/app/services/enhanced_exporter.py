...
class ExportResult(BaseModel):
    ...
    validation: ValidationResult | None = Field(default=None, description="Doğrulama sonucu")
...
class EnhancedExporter:
        ...
        with create_span("enhanced_export") as span:
            ...
            try:
                ...
                if output_path.exists():
                    ...
                    # Calculate SHA256 asynchronously with chunked reading for memory efficiency
    ...
    async def _export_pcd(self, document: Any, output_path: Path, options: ExportOptions) -> dict:
        ...
        # Create temp file for points - wrap blocking I/O in asyncio.to_thread
    ...
    async def _verify_export(self, file_path: Path, format: ExportFormat, options: ExportOptions) -> dict:
        ...
        # Check file size - wrap blocking stat in asyncio.to_thread
