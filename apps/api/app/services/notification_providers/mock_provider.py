...
class MockNotificationProvider(NotificationProvider):
    ...
    async def send_email(self, notification: EmailNotification) -> NotificationResult:
        ...
        try:
            ...
            return self.create_error_result(error_code="invalid_email", error_message=str(e))
    ...
    async def send_sms(self, notification: SMSNotification) -> NotificationResult:
        ...
        try:
            ...
            return self.create_error_result(
                error_code="invalid_phone", error_message=f"Invalid phone number: {e}"
            )
    ...
    def simulate_webhook_event(
        self, message_id: str, event_type: str = "delivered"
    ) -> Dict[str, Any]:
