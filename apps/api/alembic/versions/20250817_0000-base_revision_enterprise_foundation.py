...
def upgrade() -> None:
    ...
    try:
        ...
        print(f"❌ Enterprise base revision failed: {e}")
        raise
    finally:
...
def downgrade() -> None:
    ...
    try:
        # Drop enterprise tables in reverse order
        ...
        print("✅ Enterprise base revision downgraded")
        print("   - All enterprise infrastructure removed")
        print("   - Audit trails cleared")
        print("   - Performance baselines removed")
        
    except Exception as e:
        print(f"❌ Enterprise base revision downgrade failed: {e}")
        raise