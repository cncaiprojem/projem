...
notification_channel_enum = ENUM(
    "email", "sms", name="notification_channel_enum", create_type=False
)
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Text(),
            nullable=True,
            comment="Email subject template (null for SMS)",
        ),
        sa.Column(
            "body_template", sa.Text(), nullable=False, comment="Email HTML or SMS text template"
        ),
        sa.Column(
            "plain_text_template", sa.Text(), nullable=True, comment="Email plain text fallback"
        ),
        ...
        sa.Column(
            "max_length", sa.Integer(), nullable=True, comment="Max rendered length (160 for SMS)"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=True,
            index=True,
            comment="Null for non-license notifications",
        ),
        sa.Column(
            "template_id",
            sa.BigInteger(),
        ...
        sa.Column(
            "subject", sa.String(255), nullable=True, comment="Rendered subject (null for SMS)"
        ),
        ...
        # Delivery tracking
        sa.Column(
            "status", notification_status_enum, nullable=False, server_default="queued", index=True
        ),
        sa.Column(
            "priority",
            sa.String(10),
        ...
        sa.CheckConstraint(
            "retry_count <= max_retries", name="ck_notifications_delivery_retry_limit"
        ),
        sa.CheckConstraint(
    ...
    op.create_table(
        ...
        sa.Column(
            "provider_request", JSONB, nullable=True, comment="Request payload sent to provider"
        ),
        sa.Column(
            "provider_response", JSONB, nullable=True, comment="Response received from provider"
        ),
        ...
        sa.Column(
            "duration_ms", sa.Integer(), nullable=True, comment="Attempt duration in milliseconds"
        ),
        # Constraints
