...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("endpoint", sa.String(255), nullable=False, comment="API endpoint path"),
        sa.Column("method", sa.String(10), nullable=False, comment="HTTP method (POST, PUT, etc.)"),
        sa.Column(
            "response_status", sa.Integer(), nullable=False, comment="HTTP response status code"
        ),
        sa.Column(
            "response_data",
