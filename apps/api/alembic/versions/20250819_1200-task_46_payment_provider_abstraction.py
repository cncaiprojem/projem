...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "invoice_id", sa.BigInteger(), nullable=False, comment="Invoice this payment is for"
        ),
        ...
        sa.Column(
            "status",
            payment_status_enum,
            server_default=sa.text("'requires_action'"),
            nullable=False,
            comment="Payment status",
        ),
        # Provider request/response logging - Task 4.6 specification
        sa.Column(
            "raw_request", postgresql.JSONB(), nullable=True, comment="Raw provider request data"
        ),
        sa.Column(
            "raw_response", postgresql.JSONB(), nullable=True, comment="Raw provider response data"
        ),
        # Timestamps
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column(
            "provider", sa.String(length=50), nullable=False, comment="Payment provider identifier"
        ),
        sa.Column(
            "event_type",
        ...
        # Raw event data
        sa.Column(
            "raw_event", postgresql.JSONB(), nullable=False, comment="Raw webhook event data"
        ),
        # Timestamps
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        # Event context
        sa.Column(
            "context", postgresql.JSONB(), nullable=True, comment="Additional context and metadata"
        ),
    ...
    op.create_index(
        "idx_webhook_events_provider_processed", "payment_webhook_events", ["provider", "processed"]
    )
