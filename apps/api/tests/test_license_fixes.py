...
class TestScopeValidation:
    ...
    def test_valid_scope(self):
        ...
        valid_scope = {
            "features": {"cam_generation": True, "gcode_export": True, "simulation": False},
            "limits": {"max_jobs": 100, "storage_gb": 50, "api_calls_per_day": 10000},
        }

        # This should not raise an error
        request = LicenseAssignRequest(type="12m", scope=valid_scope)
    ...
    def test_missing_features_key(self):
        ...
        with pytest.raises(ValueError, match="Scope must contain 'features' key"):
            LicenseAssignRequest(type="12m", scope=invalid_scope)

    def test_missing_limits_key(self):
        """Test scope validation with missing limits key."""
        invalid_scope = {"features": {"cam_generation": True}}
    ...
    def test_invalid_features_type(self):
        ...
        invalid_scope = {"features": "not_a_dict", "limits": {"max_jobs": 100}}
    ...
    def test_invalid_limits_type(self):
        ...
        invalid_scope = {"features": {"cam_generation": True}, "limits": ["not", "a", "dict"]}
...
class TestIdempotencyService:
    ...
    async def test_store_and_retrieve_response(self):
        ...
        with patch.object(
            IdempotencyService, "store_response", new_callable=AsyncMock
        ) as store_mock:
    ...
    async def test_expired_record_handling(self):
        ...
        with patch.object(IdempotencyService, "get_response", new_callable=AsyncMock) as get_mock:
            ...
            result = await IdempotencyService.get_response(db_mock, key, user_id)
