...
class TestOutputEncodingService:
    ...
    def test_javascript_string_encoding(self):
        ...
        test_cases = [
            ...
            ("<script>alert('xss')</script>", '"\\x3Cscript\\x3Ealert(\\'xss\\')\\x3C\\x2Fscript\\x3E"'),
            ("", '""'),
            (None, '""'),
        ]
    ...
    def test_context_based_encoding(self):
        ...
        contexts = [html_result, js_result, css_result, url_result, json_result, xml_result, attr_result]
