...
class TestSessionModel:
    ...
    def test_session_rotation_chain(self, db: DBSession):
        ...
        # Create root session
        session1 = Session.create_default_session(
            user_id=user.id,
        ...
        session3 = Session.create_default_session(
            user_id=user.id,
            refresh_token_hash="i" * 128
        )
