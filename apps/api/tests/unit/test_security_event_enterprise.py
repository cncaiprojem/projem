...
class TestSecurityEventEnterprise:
    ...
    def test_create_login_failed_factory(self):
        ...
        event = SecurityEvent.create_login_failed(
            user_id=123,
            ip="192.168.1.50",
            ua="Firefox/91.0"
        )
        ...
        anon_event = SecurityEvent.create_login_failed(
            ip="203.0.113.1"
        )
    ...
    def test_is_login_related(self):
        ...
        login_events = [
            ...
            SecurityEvent(type="BRUTE_FORCE_DETECTED", user_id=None, created_at=datetime.now(timezone.utc)),
        ...
        non_login_events = [
            ...
            SecurityEvent(type="PRIVILEGE_ESCALATION", user_id=1, created_at=datetime.now(timezone.utc)),
        ]
    ...
    def test_is_access_related(self):
        ...
        access_events = [
            SecurityEvent(type="ACCESS_DENIED", user_id=1, created_at=datetime.now(timezone.utc)),
            SecurityEvent(type="PRIVILEGE_ESCALATION", user_id=1, created_at=datetime.now(timezone.utc)),
            SecurityEvent(type="UNAUTHORIZED_ACCESS", user_id=1, created_at=datetime.now(timezone.utc)),
            SecurityEvent(type="RESOURCE_ACCESS_DENIED", user_id=1, created_at=datetime.now(timezone.utc)),
        ]
        ...
        non_access_events = [
            SecurityEvent(type="LOGIN_FAILED", user_id=1, created_at=datetime.now(timezone.utc)),
            SecurityEvent(type="DATA_BREACH", user_id=None, created_at=datetime.now(timezone.utc)),
            SecurityEvent(type="DDOS_DETECTED", user_id=None, created_at=datetime.now(timezone.utc)),
        ]
    ...
    def test_is_suspicious(self):
        ...
        suspicious_events = [
            SecurityEvent(type="SUSPICIOUS_LOGIN", user_id=1, created_at=datetime.now(timezone.utc)),
            SecurityEvent(type="SUSPICIOUS_ACTIVITY", user_id=1, created_at=datetime.now(timezone.utc)),
            SecurityEvent(type="BRUTE_FORCE_DETECTED", user_id=None, created_at=datetime.now(timezone.utc)),
            SecurityEvent(type="RATE_LIMIT_EXCEEDED", user_id=1, created_at=datetime.now(timezone.utc)),
            SecurityEvent(type="UNUSUAL_LOCATION", user_id=1, created_at=datetime.now(timezone.utc)),
            SecurityEvent(type="MULTIPLE_DEVICES", user_id=1, created_at=datetime.now(timezone.utc)),
        ]
    ...
    def test_security_event_types_turkish_compliance(self):
        ...
        turkish_events = [
            SecurityEvent(type="KIMLIK_DOGRULAMA_HATASI", user_id=1, created_at=datetime.now(timezone.utc)),
            SecurityEvent(type="YETKISIZ_ERISIM", user_id=1, created_at=datetime.now(timezone.utc)),
            SecurityEvent(type="SUPHELI_AKTIVITE", user_id=1, created_at=datetime.now(timezone.utc)),
            SecurityEvent(type="SISTEM_GUVENLIK_IHLALI", user_id=None, created_at=datetime.now(timezone.utc)),
        ]
