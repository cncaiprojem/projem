...
class TestRBACDependencyIntegration:
    ...
    def test_require_scopes_success(self, mock_auth):
        ...
        assert response.status_code == 200 or response.status_code == 422  # Validation might fail, but auth should pass
...
class TestRBACZeroFalsePositives:
    ...
    def test_no_false_negatives_engineer_model_access(self, mock_auth):
        ...
        assert response.status_code in [200, 422], "Engineer incorrectly denied access to design endpoints"
