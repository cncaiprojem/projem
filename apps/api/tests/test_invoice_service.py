...
class TestInvoiceNumberGeneration:
    ...
    def test_invoice_number_format(self):
        ...
        # Verify SQL was executed with FOR UPDATE for locking
        executed_query = mock_db.execute.call_args[0][0]
        assert "FOR UPDATE" in str(executed_query)
...
class TestInvoiceRetrieval:
    ...
    def test_get_user_invoices_filtered(self, mock_db_with_invoices):
        ...
        unpaid_invoices = InvoiceService.get_user_invoices(
            db, user, PaidStatus.UNPAID
        )
